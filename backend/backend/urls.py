...
urlpatterns = [
    ...
    path("dislike_song", fwpods_be.views.DislikeSong.as_view()),
    path("get_song_like", fwpods_be.views.GetSongLike.as_view()),
    ...
    path("get_song_cover", fwpods_be.views.GetSongCover.as_view()),
]
